...
public class NormalRandomStatementGenerator extends RandomStatementGenerator{ 
    ...
    public NormalRandomStatementGenerator(int fun_start, int fun_stop,int funlen,int numvarvals){
            //sizeMean = avg; 
            ...
            setVariableGenerator("Normal",0,numvarvals);
            setFunctionGenerator("Normal",_fun_start,_fun_stop);
